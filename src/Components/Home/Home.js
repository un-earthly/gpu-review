        ...
        <main className="md:p-20">
            ...
            <div className="flex mt-24 flex-col md:flex-row p-4 items-center justify-center">
                ...
                <div className='mt-24 mb-12 text-center md:text-left'>
                    ...
                    <p className="md:text-xl text-sm md:tracking-wider md:leading-7 m-4 md:my-10 md:mx-0 capitalize"> Lets hear your thoughs about Latest Market Leading gpu. how was the pricing? what about productivity? was it able to give the best for this price?</p>

    ...
    return (
        <main className="p-20">
            ...
            <div className="flex mt-24 ">
                ...
                <div className="texts">
                    <h1 className="text-6xl leading-[1.3] text-[cyan]">Your Top Most Desired GPU</h1>
            ...
            {/* reviews */}
            <div className='my-40'>
                <h1 className="text-4xl text-center text-[cyan]">Customer Reviews({review.slice(0, 3).length})</h1>
